# Sorted Instructions for User - Logical Order

## Category 1: Debugging Extension Issues
...
4. Look for: `Found 8 commands`
5. Look for: `✅ All 8 commands registered successfully`
...
### Force Reload
1. `Cmd+Shift+P` → `Developer: Reload Window` (or restart VS Code)
2. Check logs again after reload
...
## Category 2: Validation - Critical Bug Fixes (Phase 0)
...
## Category 3: Validation - Environment Setup
...
## Category 4: Validation - Test File Process
...
## Category 5: Validation - Specific Test Validations
...
## Category 6: Log Analysis Instructions
...
## Category 7: Documentation Updates
...
## Category 8: Reporting Instructions
...
## Category 9: Commands to Execute
...
```bash
grep "registerCommand" out/extension.js | wc -l  # Should show 8
grep "dataflowAnalyzer\." package.json | grep command | wc -l  # Should show 8
```
